...
%                 users.
  ...
  tiffOpts      = ecsOpts;
  if isempty(LIBTIFF)
    tiffOpts    = [ tiffOpts, { '-ltiff' , '-L/usr/local/opt/libtiff/lib', '-I/usr/local/opt/libtiff/include'} ];
  else
    tiffOpts    = [ tiffOpts                                                                          ...
                  , { '-ltiff'                                                                        ...
  ...
  %% Ensure presence of GIT hooks and version file
  clear mex;
  installGitHooks(PRINCETONECS);
